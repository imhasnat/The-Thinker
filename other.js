...
const displayNews = (categoryNews, categoryName) => {
    ...
    if (numberOfNews > 0) {
        sortCategoryNews.forEach(news => {
            const { image_url, thumbnail_url, title, details, total_view, author, category_id } = news;
                    ...
                    <div class="col-md-9 p-3">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                               ...
                               <div> 
                                    <a class="pe-2" onclick="displayModal(${category_id})" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-arrow-right"></i></a>
                               </div>
                            </div>
                        </div>
                    </div>
